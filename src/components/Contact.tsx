...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const mailtoLink = `mailto:mskishore.deals@gmail.com?subject=Portfolio Inquiry from ${formState.name}&body=${encodeURIComponent(formState.message)}`;
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white font-medium">Mysore, Karnataka, India</p>
                  </div>
                </div>
      ...
      >
        <div className="flex items-center justify-start text-left">
          <p className="text-xs text-ash" suppressHydrationWarning>
            © {new Date().getFullYear()} Kishore M S. Crafted with passion.
          </p>
        </div>
      </div>
    </section>
